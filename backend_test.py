...
if __name__ == "__main__":
    ...
    # Run Enhanced QMS testing as requested
    print("🎯 ENHANCED QUOTATION MANAGEMENT SYSTEM TESTING")
    print("Testing the enhanced QMS backend APIs as per review request")
    print("Focus: Product Catalog, Hierarchical Quotations, Calculated Fields, Master Data")
    print("="*80)
    ...
    # Run Enhanced QMS testing
    enhanced_qms_success = tester.test_enhanced_quotation_management_system()
    
    # Print final results
    print("\n" + "="*80)
    print("🎯 ENHANCED QUOTATION MANAGEMENT SYSTEM TEST RESULTS")
    print("="*80)
    ...
    if enhanced_qms_success:
        print("🎉 EXCELLENT! Enhanced Quotation Management System is working correctly!")
        print("✅ Product Catalog API")
        print("   - Products available for quotation item selection")
        print("   - 5-level hierarchy structure verified")
        print("   - Enhanced item fields available")
        print("✅ Master Data Dependencies")
        print("   - Currency master data working")
        print("   - Pricing lists, discount rules available")
        print("   - All required master data endpoints functional")
        print("✅ Enhanced Quotation Creation")
        print("   - Hierarchical quotation structure (Phases → Groups → Items)")
        print("   - Enhanced quotation fields implemented")
        print("   - Realistic data testing with 2 phases")
        print("✅ Quotation Persistence")
        print("   - Complete hierarchy save and retrieve working")
        print("   - Enhanced phase, group, and item fields persisted")
        print("   - Data integrity maintained")
        print("✅ Calculated Fields")
        print("   - OTP, recurring monthly, tenure-based totals")
        print("   - Phase/group aggregations working")
        print("   - Grand total calculations functional")
        print("✅ Business Logic")
        print("   - Quotation submission workflow")
        print("   - Export functionality (PDF/Excel)")
        print("   - Enhanced validation and error handling")
    else:
        print("❌ Enhanced Quotation Management System has issues that need attention.")
        print("Some enhanced QMS components may not be working correctly.")
        print("Please review the test results above for specific failures.")
    
    exit(0 if enhanced_qms_success else 1)